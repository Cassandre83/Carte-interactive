...
leaflet(Data_entrants %>%
  ...
  addTiles() %>%
  addMarkers(lat = ~Latitude, lng=~Longitude) #� compl�ter
...
ui <- fluidPage(
  ...
  fluidRow(column(2,radioButtons("radio", h3("Select the accord"),
                                 choices = list("Bilateral" = "Bilat�ral", "ERASMUS" = "ERASMUS", "MEXFITEC"="MEXFITEC", "BRAFITEC"="BRAFITEC", "BRAFAGRI"="BRAFAGRI","ARFITEC"="ARFITEC"),
  ))))
